    ...
    <foooter className="mx-auto bg-[#F7F7F7] text-black dark:bg-gray-800 dark:text-white pt-20 mt-5 pb-5">
       ...
       {/* logo and Ditals  */}
          ...
          <div  className="space-y-2 ">
              ...
              <ul>
                 <li>
                     <Link to="/" className="hover:text-primary flex items-center space-x-2"><FaFacebook />Facebook</Link>
                 </li>
                 <li>
                     <Link to="/" className="hover:text-primary flex items-center space-x-2"><IoLogoTwitter /> Twitter</Link>
                 </li>
                 <li>
                     <Link to="/" className="hover:text-primary flex space-x-2 items-center"><AiFillInstagram /> Instagram</Link>
                 </li>
              </ul>
          </div>
