    ...
    <div>
      ...
      <div className="p-6 bg-white dark:bg-black shadow-sm">
          ...
          <div className="mt-5 flex justify-between items-center">
             <p className="text-scondary dark:text-white font-bold text-lg"><sup>$</sup><span>{product.price}</span></p>
             <button className="bg-secondary hover:bg-primary text-white dark:bg-white p-2 rounded-full"><FaPlus /></button>
          </div>
      </div>
    </div>
  );
